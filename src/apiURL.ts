...
export async function obtenerProyectos(){
	...
	return await fetch("https://cdn.contentful.com/spaces/0q692q1cfe6h/environments/master/entries?access_token=VlgYpjdWI8YUg5Mthuwkb-HuPbcBKUuvvLtEl0W-wew&content_type=portfolio")
	.then(res=>{
		return res.json();
	}).then(obj=>
		{ 
